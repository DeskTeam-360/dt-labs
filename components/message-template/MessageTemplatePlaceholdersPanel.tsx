...
import {
  MESSAGE_TEMPLATE_PASSWORD_RESET_PLACEHOLDERS,
  MESSAGE_TEMPLATE_RECIPIENT_PLACEHOLDERS,
  MESSAGE_TEMPLATE_REPLY_PLACEHOLDERS,
    ...
    <Alert
      ...
      description={
        <Space direction="vertical" size="small" style={{ width: '100%' }}>
          ...
          <div>
            <Text strong>Reply / Note</Text>
            <div style={{ marginTop: 6 }}>
              {MESSAGE_TEMPLATE_REPLY_PLACEHOLDERS.map(({ key, description }) => (
                <div key={key} style={{ marginBottom: 6 }}>
                  <PlaceholderTag token={key} />
                  <Text type="secondary" style={{ fontSize: 12, marginLeft: 8 }}>
                    {description}
          ...
          <div>
            ...
            <div style={{ marginTop: 6 }}>
              {MESSAGE_TEMPLATE_PASSWORD_RESET_PLACEHOLDERS.map(({ key, description }) => (
                <div key={key} style={{ marginBottom: 6 }}>
                  <PlaceholderTag token={key} />
                  <Text type="secondary" style={{ fontSize: 12, marginLeft: 8 }}>
                    {description}
