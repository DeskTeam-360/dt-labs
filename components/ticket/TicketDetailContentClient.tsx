...
import type { TicketDetailContentProps } from '@/components/content/ticket/TicketDetailContent'

/** `ssr: false` must live in a Client Component (Next.js 16). Avoids NP extension hydration noise on inputs. */
const TicketDetailContent = dynamic(() => import('@/components/content/ticket/TicketDetailContent'), {
  ssr: false,
  loading: () => (
